            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="laporankehadiran.html"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Lihat Laporan Kehadiran</a>
                    </div>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Area Chart -->
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Input Kehadiran</h6>
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="#">Buat Surat Cuti</a>
                                            <a class="dropdown-item" href="lihatkalender.html">Lihat Kalendar</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Card Body - Calendar -->
                                        ...
                                        <div class="col-md-6 mx-auto">
                                            ...
                                            <div class="form-group mb-4">
                                                <div class="datepicker date input-group p-0 shadow-sm">
                                                    <input type="text" placeholder="Pilih Tanggal Kehadiran"
                                            ...
                                            <!-- Keterangan Tanggal Kehadiran -->
                                            <div class="text-center">
                                                <p class="font-italic text-muted mb-0">Kehadiran hari ini</p>
                                                <h4 id="pickedDate" class="font-weight-bold text-uppercase mb-3">Belum
                                                    dipilih</h4>
                                                <a href="#"
                                                    class="btn btn-primary btn-sm px-4 rounded-pill text-uppercase font-weight-bold shadow-sm">Hadir</a>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Pilih "Logout" di bawah ini jika
                    Anda ingin
                    keluar dari
                    sesi
                    Anda.</div>
